        ...
        <div className="container" style={{ position: 'relative' }}>
          <Reveal>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
              ...
              <span style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--red)' }}>Capacidad 02</span>
            </div>
            <h1 style={{ fontFamily: 'var(--font-barlow), sans-serif', fontWeight: 800, fontSize: 'clamp(48px, 8vw, 96px)', lineHeight: 0.9, letterSpacing: '-0.02em', textTransform: 'uppercase', color: 'var(--text)', marginBottom: '32px' }}>
              Metal<br /><span style={{ color: 'var(--red)' }}>mecánica</span>
            </h1>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="grid-2">
            ...
            <Reveal delay={0.15} direction="left">
              <div style={{ fontFamily: 'var(--font-barlow)', fontWeight: 800, fontSize: '120px', lineHeight: 1, color: 'rgba(224,41,7,0.08)', letterSpacing: '-0.04em', marginBottom: '-40px' }}>02</div>
              <h2 style={{ fontFamily: 'var(--font-barlow)', fontWeight: 800, fontSize: 'clamp(28px, 4vw, 48px)', lineHeight: 1, letterSpacing: '-0.02em', textTransform: 'uppercase', color: 'var(--text)', marginBottom: '24px' }}>Estructuras metálicas<br />de alta resistencia</h2>
      ...
      <section style={{ padding: '100px 0', background: 'var(--red)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.85)', marginBottom: '40px', maxWidth: '440px', margin: '0 auto 40px' }}>Cuéntanos qué necesitas fabricar. Respondemos en menos de 24 horas.</p>
