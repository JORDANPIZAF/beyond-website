...
const capabilityIcons = [Scissors, Ruler, PaintBucket, Sofa, Link2, Layers]
...
export default function CarpinteriaPage() {
  ...
  const page = t.capacidadesPages.carpinteria
        ...
        <div className="container" style={{ position: 'relative' }}>
          <Reveal>
            ...
            <TextReveal as="h1" style={{
              ...
              {page.titleLines[0]}<br />
              <span style={{ color: 'var(--accent)' }}>{page.titleLines[1]}</span>
            </TextReveal>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="grid-2">
            ...
            <Reveal delay={0.15} direction="left">
              ...
              }}>{page.sectionTitle[0]}<br />{page.sectionTitle[1]}</TextReveal>
        ...
        <div className="container">
          <Reveal>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '48px', flexWrap: 'wrap', gap: '16px' }}>
              ...
              }}>{cap.relatedTitle1}<br /><span style={{ color: 'var(--accent)' }}>{cap.relatedAccent}</span></TextReveal>
