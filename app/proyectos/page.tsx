...
const projectsData = [
  { id: 1,  slug: 'lg-vitrina-bucaramanga',  title: 'LG Vitrina Bucaramanga',    categoryEs: 'Arquitectura Comercial',  client: 'LG',          year: '2024', cover: '/images/portfolio/arq-comercial/img/p3/vitrina_buc_INT-1-.webp' },
  { id: 2,  slug: 'samsung-galaxy-studio',   title: 'Samsung Galaxy Studio',      categoryEs: 'Arquitectura Efímera',    client: 'Samsung',     year: '2024', cover: '/images/portfolio/arq-efimera/img/01/GALAXY-S-INT-1.webp' },
  { id: 3,  slug: 'olimpica-licores',        title: 'Olímpica Licores',           categoryEs: 'Góndolas',               client: 'Olímpica',    year: '2024', cover: '/images/portfolio/gondolas/imge/01/GONDOLAS_-INT-1.webp' },
  { id: 4,  slug: 'oficinas-bogota',         title: 'Oficinas Bogotá',            categoryEs: 'Mobiliario',             client: 'Corporativo', year: '2023', cover: '/images/portfolio/mobiliario/img/01/OFI-BOGOTÁ-INT-1.webp' },
  { id: 7,  slug: 'lg-arq-comercial',        title: 'LG Arquitectura Comercial',  categoryEs: 'Arquitectura Comercial',  client: 'LG',          year: '2023', cover: '/images/portfolio/arq-comercial/img/p1/ARQ_COMERCIAL_02INT-2.webp' },
  { id: 8,  slug: 'tcl-tv-wall',             title: 'TCL TV Wall',                categoryEs: 'Arquitectura Efímera',    client: 'TCL',         year: '2023', cover: '/images/portfolio/arq-efimera/img/03/wall_tcl_INT-1-.webp' },
  ...
  { id: 18, slug: 'apple-isla',              title: 'Apple Isla',                 categoryEs: 'Arquitectura Efímera',    client: 'Apple',       year: '2021', cover: '/images/portfolio/arq-efimera/img/04/isla_appleINT-3.webp' },
  { id: 19, slug: 'amd-mesa',               title: 'AMD Mesa',                   categoryEs: 'Arquitectura Efímera',    client: 'AMD',         year: '2020', cover: '/images/portfolio/arq-efimera/img/05/mesa-amd_INT-1-.webp' },
  { id: 21, slug: 'isimo-to-go',             title: 'Isimo To Go',                categoryEs: 'Góndolas',               client: 'Isimo',       year: '2026', cover: '/images/portfolio/gondolas/isimo/isimo-portada.webp' },
  { id: 22, slug: 'lg-road-show',            title: 'LG Road Show',               categoryEs: 'Arquitectura Efímera',    client: 'LG',          year: '2026', cover: '/images/portfolio/arq-efimera/lg-road-show/lg-roadshow-portada.webp' },
  { id: 23, slug: 'plataforma-masajeadoras-el-dorado', title: 'Plataforma Sillas Masajeadoras — El Dorado', categoryEs: 'Mobiliario', client: 'El Dorado',   year: '2026', cover: '/images/portfolio/mobiliario/aeropuerto-el-dorado/aeropuerto-portada.webp' },
  { id: 24, slug: 'nespresso-al-agua-patos', title: 'Stand Nespresso × Al Agua Patos', categoryEs: 'Arquitectura Efímera', client: 'Nespresso',   year: '2026', cover: '/images/portfolio/arq-efimera/nespresso-al-agua-patos/nespresso-portada.webp' },
  { id: 25, slug: 'relojeria-falabella-unicentro', title: 'Relojería Falabella Unicentro', categoryEs: 'Arquitectura Comercial', client: 'Falabella', year: '2026', cover: '/images/portfolio/arq-comercial/relojeria-falabella/relojeria-portada.webp' },
  { id: 26, slug: 'falabella-colina',        title: 'Calzado Falabella Colina',    categoryEs: 'Arquitectura Comercial', client: 'Falabella', year: '2026', cover: '/images/portfolio/arq-comercial/falabella-colina/falabella-colina-portada.webp' },
  { id: 27, slug: 'olimpica-mallorquin',      title: 'Olímpica Mallorquín',         categoryEs: 'Góndolas',               client: 'Olímpica',   year: '2026', cover: '/images/portfolio/gondolas/olimpica-mallorquin/mallorquin-portada.webp' },
]
